                                ...
                                aria-labelledby="alertsDropdown">
                                    ...
                                    @foreach ($level_1 as $item)
                                        ...
                                        <div class="text-center mt-2 mb-2">
                                            ...
                                            <a href="{{ route('approval_notiv_level_1') }}" class="badge badge-success">Tampilkan Semua</a>
                                            @endif
                                        </div>
                                    </div>
                            </li>
                                ...
                                aria-labelledby="alertsDropdown">
                                    ...
                                    @foreach ($level_2 as $item)
                                        ...
                                        <div class="text-center mt-2 mb-2">
                                            ...
                                            <a href="{{ route('approval_notiv_level_2') }}" class="badge badge-success">Tampilkan Semua</a>
                                            @endif
                                        </div>
                                    </div>
                            </li>
                                ...
                                aria-labelledby="alertsDropdown">
                                    ...
                                    @foreach ($level_3 as $item)
                                        ...
                                        <div class="text-center mt-2 mb-2">
                                            ...
                                            <a href="{{ route('approval_notiv_level_3') }}" class="badge badge-success">Tampilkan Semua</a>
                                            @endif
                                        </div>
                                    </div>
                            </li>
